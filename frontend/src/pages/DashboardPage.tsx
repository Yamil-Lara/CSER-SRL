...
export function DashboardPage() {
 ...
 <h2 className="text-lg font-bold ">Mis Proyectos Recientes</h2>
 ...
 <th className="px-5 py-3 text-sm font-bold opacity-50 uppercase tracking-wider">Proyecto</th>
 <th className="px-5 py-3 text-sm font-bold opacity-50 uppercase tracking-wider">Tecnologías</th>
 <th className="px-5 py-3 text-sm font-bold opacity-50 uppercase tracking-wider">Estado</th>
 <th className="px-5 py-3 text-sm font-bold opacity-50 uppercase tracking-wider text-right">Acciones</th>
 </tr>
 </thead>
 ...
 <div className="w-12 h-12 bg-muted dark:bg-slate-800/50 rounded-lg flex items-center justify-center overflow-hidden flex-shrink-0 border border-muted dark:border-slate-700">
 {project.imagen_url ? (
 <img
 ...
 <FolderGit2 className="w-6 h-6 opacity-40 dark:opacity-60" />
 )}
 </div>
 <div className="max-w-[150px] sm:max-w-xs">
 <h3 className="font-semibold text-base line-clamp-1">{project.titulo}</h3>
 <p className="text-sm opacity-50 line-clamp-1 mt-0.5">{project.descripcion}</p>
 </div>
 </div>
 </td>
 <td className="px-5 py-4">
 ...
 <Edit className="w-4.5 h-4.5 opacity-60 hover:text-primary" />
 </Button>
 </Link>
 <Button
 variant="ghost"
 ...
 <div className="w-20 h-20 rounded-full bg-muted dark:bg-slate-800/50 flex items-center justify-center mx-auto mb-4">
 <FolderGit2 className="w-10 h-10 opacity-40 dark:opacity-60" />
 </div>
 ...
 <Card className="!p-0 overflow-hidden hover:shadow-md transition-all duration-200 ">
 <div className="flex items-center justify-between px-5 py-4 border-b border-muted">
 <h2 className="text-lg font-bold ">Visualizaciones a mi Perfil Profesional</h2>
 <div className="flex items-center gap-1 text-xs font-semibold opacity-40 uppercase tracking-wider">
 <span>Recientes</span>
 </div>
 </div>
 ...
 <thead>
 <tr className="border-b border-muted bg-muted/20">
 <th className="px-5 py-3 text-sm font-bold opacity-50 uppercase tracking-wider">Visitante</th>
 <th className="px-5 py-3 text-sm font-bold opacity-50 uppercase tracking-wider">Especialidad</th>
 <th className="px-5 py-3 text-sm font-bold opacity-50 uppercase tracking-wider">Visto hace</th>
 <th className="px-5 py-3 text-sm font-bold opacity-50 uppercase tracking-wider text-right">Acción</th>
 </tr>
 </thead>
 <tbody className="divide-y divide-muted">
 ...
 <div className="max-w-[150px] sm:max-w-xs">
 <h4 className="font-semibold text-base line-clamp-1">{visitor.nombre}</h4>
 <p className="text-sm opacity-50 line-clamp-1 mt-0.5">{visitor.cargo}</p>
 </div>
 </div>
 </td>
 <td className="px-5 py-4">
 ...
 <div className="text-center py-16">
 <div className="w-20 h-20 rounded-full bg-muted dark:bg-slate-800/50 flex items-center justify-center mx-auto mb-4">
 <Eye className="w-10 h-10 opacity-40 dark:opacity-60" />
 </div>
 <h3 className="text-xl font-semibold mb-1">
 ...
 <Card className="!p-0 overflow-hidden hover:shadow-md transition-all duration-200">
 <div className="flex items-center justify-between px-5 py-4 border-b border-muted ">
 <h2 className="text-lg font-bold ">Últimos Comentarios a mis Proyectos</h2>
 <div className="flex items-center gap-1 text-xs font-semibold opacity-40 uppercase tracking-wider">
 <span>Recientes</span>
 </div>
 </div>
 ...
 <thead>
 <tr className="border-b border-muted bg-muted/20">
 <th className="px-5 py-3 text-sm font-bold opacity-50 uppercase tracking-wider">Autor</th>
 <th className="px-5 py-3 text-sm font-bold opacity-50 uppercase tracking-wider">Comentario</th>
 <th className="px-5 py-3 text-sm font-bold opacity-50 uppercase tracking-wider">Proyecto</th>
 <th className="px-5 py-3 text-sm font-bold opacity-50 uppercase tracking-wider text-right">Estado</th>
 </tr>
 </thead>
 <tbody className="divide-y divide-muted">
 {comentarios.map((c) => (
 ...
 <span className="text-sm font-semibold group-hover/author:text-primary line-clamp-1 transition-colors">
 {c.autor.nombre}
 </span>
 </Link>
 ) : (
 <span className="text-sm opacity-40 italic">Anónimo</span>
 )}
 </td>
 <td className="px-5 py-4 max-w-[180px]">
 <p className="text-sm opacity-70 line-clamp-2">{c.contenido}</p>
 <span className="text-xs opacity-40">{c.tiempo}</span>
 </td>
 <td className="px-5 py-4">
 <span className="text-sm font-medium opacity-70 line-clamp-1">
 {c.proyecto.titulo}
 </span>
 </td>
 <td className="px-5 py-4 text-right">
 ...
 <div className="text-center py-16">
 <div className="w-20 h-20 rounded-full bg-muted dark:bg-slate-800/50 flex items-center justify-center mx-auto mb-4">
 <MessageSquare className="w-10 h-10 opacity-40 dark:opacity-60" />
 </div>
 <h3 className="text-xl font-semibold mb-1">
 ...
 <h2 className="text-lg font-bold ">Completitud de tu Perfil</h2>
 <span className="text-3xl font-bold ">{completitudPct}%</span>
 </div>
 ...
 <XCircle className="w-4 h-4 opacity-40 dark:opacity-60 flex-shrink-0" />
 )}
 <span className={`text-sm ${item.done ? 'opacity-70' : 'opacity-40'}`}>
 {item.label}
 </span>
 </li>
 ))}
