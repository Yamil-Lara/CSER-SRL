  ...
  return (
    <div className="project-card bg-white dark:bg-slate-800 rounded-xl shadow-sm border border-slate-200 dark:border-slate-700 overflow-hidden transition-colors">
      ...
      <div className="p-4">
        ...
        <div className="project-actions flex flex-wrap gap-2 pt-3 border-t border-[var(--border-color)]">
          <Link 
            to={`/proyecto/${project.id}`}
            className={`flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-sm font-medium transition-colors flex-1 justify-center relative ${project.comentariosNuevos && project.comentariosNuevos > 0 ? 'bg-primary/20 text-primary hover:bg-primary/30 border border-primary/30' : 'bg-primary/10 text-primary hover:bg-primary/20'}`}
          >
