    ...
    <div className="w-full py-2">
      <div className="flex justify-between items-center mb-2">
        ...
        <div className="flex items-center gap-4">
          <span className="opacity-60 text-sm font-medium">{skill.level}%</span>
          <button 
            title="Editar habilidad" 
            className="opacity-40 hover:text-primary transition-colors focus:outline-none" 
          ...
          <button 
            ...
            className="opacity-40 hover:text-destructive transition-colors focus:outline-none" 
