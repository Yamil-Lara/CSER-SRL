...
class UpdateProfileRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        'email' => ['sometimes', 'email', Rule::unique('usuarios')->ignore($this->user()->id)],
            ...
            'biografia' => ['nullable', 'string', 'max:1000', 'regex:/^[a-zA-Z0-9áéíóúüñÁÉÍÓÚÜÑ\s\(\)\&\-\.\,\!\?\'\:\;\"]*$/u'],
    ...
    public function messages(): array
    {
        ...
        'email.email' => 'Debe ingresar un correo electrónico válido',
         ...
         'password.min' => 'La contraseña debe tener al menos 8 caracteres',
            ...
            'biografia.regex' => 'La biografía contiene caracteres no permitidos. Solo se aceptan letras, números y los símbolos: () & - . , ! ? \' : ;',
